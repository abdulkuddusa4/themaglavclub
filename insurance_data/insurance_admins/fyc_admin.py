...
from insurance_data.models import TopQuartileStatus, FYC
from insurance_data.forms import FYCImportForm
import pandas as pd
import os
...
class FYCAdminMixin(admin.ModelAdmin):
    ...
    def add_view(self, request, form_url='', extra_context=None):
        ...
        form = FYCImportForm(request.POST)
        ...
        if _errs:
            ...
            for row in rows:
                agent = row['agent']
                obj, _created = FYC.objects.update_or_create(
                    agent=agent,
        ...
        return redirect(reverse(
            f"admin:{FYC._meta.app_label}_{FYC._meta.model_name}_changelist"
        ))
